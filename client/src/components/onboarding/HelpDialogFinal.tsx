                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Goldfish helps you visualize and manage your social network, not just store phone numbers.
                                    </p>
                                </div>
                                ...
                                <div className="grid gap-4">
                                    <div className="p-4 border rounded-lg bg-card">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Click the <span className="font-medium text-foreground">+</span> button in the top right to create a new contact card. You can add photos, notes, and detailed information.
                                        </p>
                                    </div>

                                    <div className="p-4 border rounded-lg bg-card">
                                        <div className="flex items-center gap-2 font-semibold mb-2">
                                            <Users className="w-4 h-4 text-primary" /> Building Relationships
                                        </div>
                                        <p className="text-sm text-muted-foreground">
                                            Open any contact's detailed view and click <span className="font-medium text-foreground">Add Related</span>. You can link them to other contacts as "Spouse", "Sibling", "Co-worker", or "Friend".
                                        </p>
                                    </div>

                                    <div className="p-4 border rounded-lg bg-card">
                                        <div className="flex items-center gap-2 font-semibold mb-2">
                                            <Share2 className="w-4 h-4 text-primary" /> Visualizing Your Network
                                        </div>
                                        <p className="text-sm text-muted-foreground">
                                            Switch between <span className="font-medium text-foreground">List View</span> for quick access and <span className="font-medium text-foreground">Graph View</span> to see how everyone connects. In Graph View, use the top filters to focus on Family, Friends, or Work circles.
                                        </p>
                                    </div>

                                    <div className="p-4 border rounded-lg bg-card">
                                        <div className="flex items-center gap-2 font-semibold mb-2">
                                            <Filter className="w-4 h-4 text-primary" /> Real-World Examples
                                        </div>
                                        <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-4">
                                            <li>
                                                <span className="font-medium text-foreground">Job Hunt:</span> Add recruiters and hiring managers, linking them to their companies and each other to track referrals.
                                            </li>
                                            <li>
                                                <span className="font-medium text-foreground">Wedding Planning:</span> Create a "Wedding" group and link guests by family or friend groups to plan seating charts.
                                            </li>
                                            <li>
                                                <span className="font-medium text-foreground">Professional Network:</span> Visualize how your mentors, colleagues, and industry contacts are connected to leverage warm introductions.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
